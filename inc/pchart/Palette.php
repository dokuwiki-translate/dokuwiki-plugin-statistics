...
class Palette
{
    ...
    public static function defaultPalette()
    {
        ...
        $palette->colors = [0 => new Color(188, 224, 46), 1 => new Color(224, 100, 46), 2 => new Color(224, 214, 46), 3 => new Color(46, 151, 224), 4 => new Color(176, 46, 224), 5 => new Color(224, 46, 117), 6 => new Color(92, 224, 46), 7 => new Color(224, 176, 46)];
